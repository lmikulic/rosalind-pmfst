...
if __name__=="__main__":
    with open("../Downloads/blosum62.scoring.txt", "r") as f:
    ...
    with open("../Downloads/rosalind_ba5e.txt", "r") as f:
        aminoacidstrings=[line.strip() for line in f.readlines()]
        first_word=aminoacidstrings[0]
        second_word=aminoacidstrings[1]
    ...
    res, backtrack = globalalignment(len(first_word), len(second_word), down, right, diagonal)
